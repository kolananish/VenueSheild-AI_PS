...
const conversations: { title: string; messages: Message[] }[] = [
  {
    ...
    messages: [
      {
        text: "Alert: Zone B crowd density at 85%. Approaching capacity threshold.",
        sender: "ai",
        delay: 0,
      },
      {
        text: "Can you show me the affected areas?",
        sender: "operator",
        delay: 1500,
      },
      {
      ...
      <div className="bg-white rounded-b-[3rem] pt-16 sm:pt-24 pb-16 sm:pb-24 px-4 relative overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            >
              Watch how VenueShield AI detects risks, provides recommendations,
              and helps operators respond in real-time.
            </p>
          </div>
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center lg:h-[600px] space-y-6 lg:space-y-8 order-2 lg:order-1">
              ...
              >
                ...
                <div className="space-y-3 lg:space-y-4 text-base lg:text-lg text-slate-700 leading-relaxed">
                  <p>
                    While your team focuses on guests, VenueShield AI monitors
                    every camera feed, detecting crowd surges, disturbances, and
                    compliance issues in real-time.
                  </p>

                  <p>
                    Every alert you're watching could be preventing an injury,
                    avoiding a lawsuit, or ensuring compliance—automatically.
                  </p>
              ...
              >
                <div className="p-4 lg:p-6 bg-slate-50 rounded-xl border-l-4 border-slate-900">
                  <p className="text-slate-800 font-medium text-sm lg:text-base">
                    "VenueShield detected a crowd surge 8 minutes before it
                    would have become dangerous. We prevented what could have
