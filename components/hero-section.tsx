  ...
  return (
    <section className="min-h-screen flex items-center justify-center px-4 py-20 relative">
      <div className="max-w-4xl mx-auto text-center relative z-10 animate-fade-in-hero">
        ...
        {/* Subheading - Updated subheading for VenueShield AI */}
        <p className="text-base sm:text-xl md:text-2xl text-white text-balance max-w-sm sm:max-w-3xl mx-auto mb-8 sm:mb-12 leading-relaxed px-4 sm:px-0 animate-fade-in-subheading font-light">
          VenueShield AI detects safety risks in real-time using your existing
          cameras. Prevent incidents, respond faster, and build visitor
          confidence.
        </p>
        ...
        <div className="text-center px-4 hidden sm:block overflow-hidden animate-fade-in-trust">
          <p className="text-sm text-white mb-6">
            Trusted by leading venues worldwide
          </p>
        ...
        {/* Mobile Trust Indicators - Updated for venue types */}
          ...
          <div className="relative overflow-hidden w-full max-w-sm mx-auto">
            ...
            <div className="flex items-center gap-6 opacity-60 animate-slide-left-mobile">
              <div className="flex items-center gap-6 whitespace-nowrap">
                <div className="text-sm font-semibold">Arenas</div>
                <div className="text-sm font-semibold">Theaters</div>
                <div className="text-sm font-semibold">Campuses</div>
                <div className="text-sm font-semibold">Nightclubs</div>
                <div className="text-sm font-semibold">Stadiums</div>
                <div className="text-sm font-semibold">Centers</div>
              </div>
              {/* Duplicate for seamless loop */}
              <div className="flex items-center gap-6 whitespace-nowrap">
                <div className="text-sm font-semibold">Arenas</div>
